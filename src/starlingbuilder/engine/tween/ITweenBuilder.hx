...
interface ITweenBuilder
{
    /**
         ...
         */
    function start(root:DisplayObject, paramsDict:Map<Dynamic, Dynamic>, names:Array<Dynamic> = null):Void;
    ...
    /**
         ...
         */
    function stop(root:DisplayObject, paramsDict:Map<Dynamic, Dynamic> = null, names:Array<Dynamic> = null):Void;
}
